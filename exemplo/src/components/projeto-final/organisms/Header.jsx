// Organismo: cabeçalho principal da aplicação.
// Controla a navegação, autenticação e troca de tema.
...
const Header = () => {
    ...
    // Classes padrão usadas pelos links de navegação.
    ...
    return (
        <nav className="border-b border-gray-200 bg-white px-8 py-4 text-gray-900 shadow-lg transition-colors dark:border-gray-800 dark:bg-gray-950 dark:text-white">
            <div className="mx-auto flex max-w-7xl items-center justify-between">
                ...
                {/* Logo: leva para a área do usuário ou para o login. */}
                <NavLink
                ...
                <div className="flex items-center gap-2">
                    ...
                    {/* Mostra Login e Registro quando não há usuário autenticado. */}
                    {!token && (
                        <>
                            <NavLink
                                to="/login"
                    ...
                    {/* Mostra a navegação da área do usuário quando autenticado. */}
                    {token && (
                        <>
                            <NavLink
                                to="/user/home"
